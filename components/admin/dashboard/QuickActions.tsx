        ...
        {actions.map((a) => {
          ...
          return (
            <Wrapper
              ...
              onClick={a.onClick}
              type={"button"}
              className="group flex w-full items-center gap-3 rounded-xl bg-white/[0.06] px-3 py-2.5 text-left text-sm font-medium text-white transition-all hover:bg-white/[0.12]"
            >
