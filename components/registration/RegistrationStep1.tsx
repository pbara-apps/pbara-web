  ...
  return (
    ...
    >
      ...
      {program.flyerImageUrl ? (
        <div className="relative aspect-[16/10] overflow-hidden rounded-2xl border border-slate-200/80 bg-slate-100 shadow-sm md:aspect-[21/9]">
          <Image
      ...
      >
        <div className="border-b border-slate-100 bg-gradient-to-br from-primary via-[#1f2a5c] to-[#2a3568] px-6 py-7 text-white md:px-8">
          ...
          <p className="mt-2 max-w-lg text-sm text-white/70">
            Transfer the exact amount to the account below, then continue with
            your registration details and proof of payment.
          </p>
        </div>
      ...
      >
        ...
        <div className="mt-4 max-h-48 overflow-y-auto rounded-xl border border-slate-100 bg-slate-50/80 px-4 py-3 text-sm leading-relaxed text-text-muted whitespace-pre-wrap">
          {terms}
        </div>
        <div className="mt-5">
          <Checkbox
